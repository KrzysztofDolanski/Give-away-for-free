...
@Service
@Transactional
public class UploadPathImpl implements UploadPathService {
    ...
    public File getFilePath(String modifiedFileName, String path) {
        ...
        String modifiedFilePatch = context.getRealPath("/"+path+"/"+File.separator+modifiedFileName);
        File file = new File(modifiedFilePatch);
        return file;
    }
}
